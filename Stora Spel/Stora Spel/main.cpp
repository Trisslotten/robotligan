...
int main(unsigned argc, char** argv) {
  ...
  std::unordered_map<int, PlayerActions> keybinds;
  keybinds[GLFW_KEY_W] = PlayerActions::WALK_FORWARD;
  keybinds[GLFW_KEY_S] = PlayerActions::WALK_BACKWARD;
  keybinds[GLFW_KEY_A] = PlayerActions::WALK_LEFT;
  keybinds[GLFW_KEY_D] = PlayerActions::WALK_RIGHT;
  ...
  while (!glob::window::ShouldClose()) {
    ...
    */
    ...
    std::bitset<PlayerActions::NUM_ACTIONS> actions;
